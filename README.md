...
<p align="center">
  ...
  <a href="https://github.com/sooryanathg">
    <img src="https://img.shields.io/badge/GitHub_personal-181717?style=for-the-badge&logo=github&logoColor=white">
  </a>
  <a href="https://github.com/sooryanath-ltdm">
    <img src="https://img.shields.io/badge/GitHub_work-238636?style=for-the-badge&logo=github&logoColor=white">
  </a>
  <a href="mailto:sooryanathgopi@gmail.com">
...
Full-stack developer and SDE I at **LinktoDM** — building and shipping features in a real production codebase while concurrently finishing my B.Tech in Information Technology.

On the frontend I work with **Svelte + TypeScript**, writing components, managing state, and keeping interfaces fast and clean. On the backend I build REST APIs with **Python + FastAPI** backed by **PostgreSQL**, handling data modelling, query optimisation, and auth flows.

Everything I build is built with actual users and production constraints in mind — not just assignments.
...
- Shipping features on a live product — Svelte frontend, FastAPI + PostgreSQL backend
- Deepening backend knowledge: query optimisation, API design patterns, system design
...
![Sooryanath's GitHub Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=sooryanathg&theme=react-dark&hide_border=true&area=true)

---

<p align="center">Open to full-time and internship opportunities &nbsp;·&nbsp; Available for collaboration</p>
